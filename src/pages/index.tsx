...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Finance Fun Kids`}</title>

        <meta
          name="description"
          content="Unlock the world of finance with Finance Fun Kids - Your child's gateway to an engaging and interactive educational journey."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjg5OTk1NzE5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the world of finance with Finance Fun Kids - Your child's gateway to an engaging and interactive educational journey.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="User" type="user" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
